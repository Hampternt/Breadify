...
**D19** cost about 5.5 mm on each block carrying a department and left the day
at 26; **D23** added the twenty-seventh when the route total began wrapping
product names inside their column instead of writing them off the edge of the
paper. Both were re-measured, not assumed.
